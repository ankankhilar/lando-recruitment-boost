        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                  {!isPlaying ? (
                    <Button
                      ...
                      className="rounded-full w-20 h-20 group-hover:scale-110 transition-transform duration-300"
                    >
          ...
          <div className="space-y-4">
            ...
            {videoFeatures.map((feature, index) => (
              <div 
                key={index} 
                className="p-4 bg-card rounded-lg shadow-soft hover:shadow-medium transition-shadow duration-300 cursor-pointer group border hover:border-primary"
              >
